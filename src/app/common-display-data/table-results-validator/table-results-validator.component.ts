 ...
 */
@Component({
    selector: 'app-table-results-validator',
    templateUrl: './table-results-validator.component.html',
    styleUrls: ['./table-results-validator.component.css'],
})
export class TableResultsValidatorComponent
    extends PaginatedSearchComponent<any>
    implements OnChanges {
